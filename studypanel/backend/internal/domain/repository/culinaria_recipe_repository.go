...
type CulinariaRecipeRepository interface {
	...
	GetBySlug(ctx context.Context, categorySlug, recipeSlug string) (*entity.CulinariaRecipe, error)
	List(ctx context.Context, categorySlug string) ([]*entity.CulinariaRecipe, error)
